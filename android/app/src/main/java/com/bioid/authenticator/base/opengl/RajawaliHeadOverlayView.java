...
public class RajawaliHeadOverlayView extends SurfaceView implements HeadOverlayView {
    ...
    @NonNull
    private HeadOverlayView.Direction currentDirection = Direction.AHEAD;
    ...
    @Override
    public void lookInto(@NonNull HeadOverlayView.Direction targetDirection) {
    ...
    private boolean isDiagonalAnimation(@NonNull HeadOverlayView.Direction targetDirection) {
